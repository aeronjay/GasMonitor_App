...
String txt_content = "Gas Leak was Detected!!!\n PLEASE CHECK YOUR PLACE IMMEDIATELY";
...
void callUp(String number) {
  ...
  SIM900A.println(";"); //Call to the specific number, ends with semi-colon,replace X with mobile number
...
void handle_MainPage() {
  ...
  mainHTML += "    <button style='padding: 5px; background-color: lightblue; font-size: 10px; color:black;' id='print'>Print History</button>\n";
  mainHTML += "    <table>\n";
  mainHTML += "      <tr>\n";
  mainHTML += "        <th>Date</th>\n";
  mainHTML += "        <th>Time</th>\n";
  ...
  mainHTML += "  const printButton = document.getElementById('print');";
  mainHTML += "  printButton.addEventListener('click', function () {window.print();});";
  mainHTML += "  </script>\n";
  mainHTML += "</body></html>\n";
...
void handle_SettingsPage() {
  ...
  settingsHTML += "      <input type='text' id='phone' name='phone' placeholder='Enter Phone Number'><br>\n";
